    ...
    <div className="bg-beige min-h-screen">
      ...
      <StarwoodPasswordGate>
        ...
        <div className="max-w-[1000px] mx-auto px-6 md:px-[60px] py-16">
          ...
          >
            With trust mechanisms locked in as baseline, the real design
            question emerged:
          </p>
          <p
            className="font-sans font-normal leading-relaxed mb-8"
          ...
          <section className="mt-16 mb-0">
            ...
            >
              Each accounting manager validated four deals using both Prototype
              A and Prototype B, which I built with{" "}
              <span style={{ fontWeight: 700 }}>v0, Claude Code, </span> and{" "}
              <span style={{ fontWeight: 700 }}>React</span>. The prototypes
              were tested in a counterbalanced order to minimize order effects
              and better isolate the impact of the design changes.
            </p>
            <Image
          ...
          <section className="mt-20 mb-0">
            ...
            >
              Every seeded error was caught. Both proposed workflows made
              boarding complexity manageable.
            </p>
            ...
            >
              ...
              <section className="mb-10">
                ...
                >
                  ...
                  Leveraging v0, Claude Code, and React allowed me to bring
                  ideas to life far faster than a traditional Figma-only
                  workflow. Faster prototyping meant quicker feedback loops,
                  reduced design waste, and narrowed focus on what actually
                  works for users. It made me more hopeful of design not being
                  the bottleneck to problem-solving as AI becomes an accelerant
                  for exploration.
                </p>
              </section>
              ...
              <section className="mb-10">
                ...
                >
                  The unique challenge here was not convincing users to use AI
                  but was designing enough trust into the system so that they
                  don&apos;t revert to their old workflow. I spent time
                  understanding emotional and operational safeguards needed
                  during the design process. Studying user behavior closely to
                  see how they validated info manually helped me ideate ways to
                  mirror those behaviors with the product experience. This
                  experience will always remind me that AI products built on
                  giving users confidence will be the most successful.
                </p>
              </section>
            </div>
          </section>
